...
datapath="../2D_readcounts"
d <- read.delim(paste0(datapath, "/2D.1o-A188FScallus.raw.read.counts"), check.names=F)
...
### output
output_file <- paste0("2E.1o-", group1, "_", group2, ".DE")
